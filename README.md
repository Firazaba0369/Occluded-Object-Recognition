...
Manually labelled, 7-8 random images from each scene, 100 images total, real world test set (too big for github to take as upload). Labels are in the labels zip.
